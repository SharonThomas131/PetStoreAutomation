/*
 * Using the properties file to get urls example - UserEndpoints2.java - UserTests2.java
 */
...
public class UserTests2 {
	...
	{ 
		...
		Response response = UserEndPoints2.getUser(this.user_payload.getUsername());
	...
	{ 
		...
		Response response = UserEndPoints2.deleteUser(this.user_payload.getUsername());
